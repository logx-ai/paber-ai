    ...
    <>
      <div className="bg-background block md:hidden">
        <main className="flex flex-col place-content-center h-[100svh]">
          ...
          <section className="justify-center px-6 md:px-0 md:flex md:w-2/3 md:border-l">
      ...
      <div className="bg-background hidden md:block">
        <main className="flex flex-col md:flex-row-reverse h-[100svh]">
          ...
          <section className="justify-center bg-grid-gray-200/[0.6] dark:lg:bg-grid-gray-800 px-4 md:px-0 md:flex md:w-2/3 md:border-l">
            <div className="w-full max-w-sm py-4 mx-auto my-auto min-w-min md:py-9 md:w-7/12">
              {children}
            </div>
          </section>
